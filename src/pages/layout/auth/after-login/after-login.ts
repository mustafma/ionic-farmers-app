...
export class AfterLoginPage {
  ...
  constructor(public navCtrl: NavController, public authData: AuthData,public alertCtrl: AlertController,public loadingCtrl: LoadingController,
    private toastCtrl: ToastController,public afAuth: AngularFireAuth, public afDb: AngularFireDatabase, private storage: Storage) {
  ...
  logout(){
        ...
        .then( authData => {
          ...
          this.storage.set('login:status',false);
          // toast message
